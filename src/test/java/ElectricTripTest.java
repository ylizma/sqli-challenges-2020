import challenges.electrictrip.ElectricTrip;
...
public class ElectricTripTest {
    ...
    public void shouldGetAtDestinationWithLowerCharge() {
        ...
        assertEquals("BOURGES",trip.locationOf(participantId));
        assertEquals("53%",trip.chargeOf(participantId)); //% is rounded to closest integer
    }
    ...
    public void shouldGoToFinalDestination() {
        ...
        trip.go(participantId);
        assertEquals("BORDEAUX",trip.locationOf(participantId) );
        assertEquals("18%",trip.chargeOf(participantId));
    }
//
    @Test
    public void shouldStayAtIntermediateStopIfNotEnoughCharge() {
        ...
        assertEquals(trip.chargeOf(participantId),"42%");
    }
//
    @Test
...
//
    ...
    public void shouldMoveMultipleParticipantsAccordingly() {
        ...
        assertEquals(trip.chargeOf(id2),"72%");
    }
//
    @Test
...
//        assertEquals(trip.chargeOf(id), is("52%"));
    }
//
//    @Test
