import challenges.event.Event;
import challenges.event.Hotel;
...
/**
 * This exercise is about organizing an IT event. If you attended the Devoxx Morocco event that was organized this week,
 * the problem we are trying to solve will sound familiar to you ;)
...
public class EventTest {
    ...
    public void can_register_a_tringa_attendee_in_event() {
        assertEquals(true, event.register("TRINGA", "Mohammed"));
    }

    @Test
    public void can_not_register_same_name_twice() {
        event.register("TRINGA", "Mohammed");
        assertEquals(false, event.register("TRINGA", "Mohammed"));
    }

    //
    @Test
    public void can_check_hotel_status() {
        assertEquals("Standard rooms: 12|Suites: 5|Aparts: 15", hotel.checkAvailibility());

//        event.register("TRINGA", "Mohammed");
//        assertEquals("Standard rooms: 11|Suites: 5|Aparts: 15", hotel.checkAvailibility());
    }
//
//    @Test
