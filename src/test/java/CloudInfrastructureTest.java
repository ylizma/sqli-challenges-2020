...
import challenges.cloudinfrastructure.CloudInfrastructure;
import challenges.cloudinfrastructure.CreateStoreException;
import challenges.cloudinfrastructure.MachineStateException;
...
//
    ...
    public void cannot_launch_already_started_machine() throws MachineStateException {
        ...
        assertThrows(MachineStateException.class,()->{
            cloud.startMachine("machine1");
...
//
    ...
    public void can_check_used_disk_per_store() throws CreateStoreException {
        ...
        assertEquals(0.100, cloud.usedDisk("myImages"), PRECISION);
...
//
     ...
     */
    @Test
    public void can_check_aggregated_data_for_all_machines_and_stores() throws MachineStateException, CreateStoreException {
        cloud.createMachine("machine1", "Linux", "50gb", "8gb");
        cloud.createMachine("machine2", "Windows", "20gb", "4gb");
        assertEquals("machine1:inactive||machine2:inactive", cloud.listMachines());
